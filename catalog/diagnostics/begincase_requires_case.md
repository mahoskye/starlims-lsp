...
```ssl
/* TODO: minimal SSL that must produce begincase_requires_case; */
```

### Does not flag

```ssl
/* TODO: nearby-but-valid SSL that must NOT produce begincase_requires_case; */
```
