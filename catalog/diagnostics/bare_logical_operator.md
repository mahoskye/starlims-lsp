...
```ssl
/* TODO: minimal SSL that must produce bare_logical_operator; */
```

### Does not flag

```ssl
/* TODO: nearby-but-valid SSL that must NOT produce bare_logical_operator; */
```
