...
> **Normative source:** [`feature.completion`](../../catalog/features/completion.md) in the behavior catalog. This page is a guide; when it disagrees with the catalog entry, the entry wins.
